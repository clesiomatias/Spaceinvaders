...
'''Clone do famoso jogo clássico de mesmo nome , criado
em python usando o módulo nativo Turtle, que é derivado
do módulo Tkinter de GUI.
...
import math
import random
import pygame #<- módulo usado para rodar arquivos de audio ( pip install pygame) 
pygame.init()#<- inicindo pygame para rodar os audios com o módulo Sound
